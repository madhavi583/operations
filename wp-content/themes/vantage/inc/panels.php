...
function vantage_prebuilt_page_layouts($layouts){
	$layouts['default-home'] = array (
		...
		array(
			...
			1 =>
			array(
				'title' => __('Urgency-click', 'vantage'),
				'image' =>'http://localhost/operation-nehemiah/wp-content/uploads/2017/04/TCC-Presentation-Template-Students.png',
				'text' => __('Pic Showing Urgency-click to Urgency Page.','vantage'),
				'icon' => 'icon-ok-circle',
				'image' => 'http://localhost/operation-nehemiah/wp-content/uploads/2017/04/TCC-Presentation-Template-Students.png',
				'icon_position' => 'top',
				'more' => __('Example Button','vantage'),
				'more_url' => 'http://localhost/operation-nehemiah/sample-page/',
				'box' => false,
				'info' =>
				array(
					'class' => 'Vantage_CircleIcon_Widget',
			...
			2 =>
			array(
				'title' => __('Brochure About ON','vantage'),
				'text' => __("This is the fourth in a series of National level events focussed on gathering senior leaders together to bring holistic Biblical perspective to the issue of Financial Integrity and discuss practical ways to address it in their own systems.",'vantage'),
				'icon' => 'icon-time',
				'image' => '',
				'icon_position' => 'top',
			...
			3 =>
			array(
				'headline' => __('WHO WE ARE','vantage'),
				'sub_headline' => __('A Movement for Transparency, Accountability and Financial Integrity in the Church in India facilitated by a group of businessmen and professionals with a desire to serve Christian leaders and institutions in our country','vantage'),
				'info' =>
				array(
			...
			array(
				...
				'text' => __('Ebooks
E-courses (Eg Sign up for personal finance course)
White Papers(Eg Robertos articles)
Talks (Sanjay Patras speech)
Standards - (ECFAs 7 principles, Lausanne standards)
Devotional (Eg. Chris Wright/LT - talks split into topics)       
Assessments(Eg. EFACs self evaluation tool) 
Downloads (Eg Mango)
Connect with our experts (Queries)  
Hotline 
Related links - CIM, Mango, Globeethics.','vantage'),
				'filter' => true,
				'info' =>
				array(
