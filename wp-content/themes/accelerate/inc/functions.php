...
function accelerate_footer_copyright() {
	...
	$wp_link = '<a href="'.esc_url( 'http://wordpress.org' ).'" target="_blank" title="' . esc_attr__( '', '' ) . '"><span>' . __( '', '' ) . '</span></a>';

	$tg_link =  '<a href="'.esc_url( 'https://themegrill.com/themes/accelerate' ).'" target="_blank" title="'.esc_attr__( '', '' ).'" rel="designer"><span>'.__( '', '') .'</span></a>';

	$default_footer_value = sprintf( __( 'Copyright &copy; %1$s %2$s.', 'accelerate' ), date( 'Y' ), $site_link ).' '.sprintf( __( '', '' ), $wp_link ).' '.sprintf( __( ' %1$s %2$s', '' ), '', $tg_link );
